...
function load() {
    ...
    function touchChangeEnd(e) {
    	...
    	var titleData=['首页', 'WLAN设置', '流量管理', '固件升级', '设备信息', '系统设置'];
        var event = e || window.event;
...
function wlan() {
    ...
    eyeCheck.click(function() {
        if (eyeCheck.attr('checked')) {
            passWlan.css('display', 'none');
            passWlanM.val(passWlan.val());
            passWlanM.css('display', 'block');
            eye.css('background-image', 'url(images/eyeActive.png)');
        } else {
            passWlanM.css('display', 'none');
            passWlan.val(passWlanM.val());
            passWlan.css('display', 'block');
            eye.css('background-image', 'url(images/eye.png)');
        }
    });
...
(function(){
	...
	setTimeout(function(){
		...
		// 如果检测新版本
			...
			$('.updateW .checkNew .checkInfo .versionInfo').html(newVersion);	
		}
	}, 2000);
	// 立即下载
